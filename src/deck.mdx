...
<RegexCompare texts={["qwe"]}/>

</Wrapper>

---

<RegexCompare texts={["adsa", "example"]} pattern={""}/>
...
<RegexCompare texts={["gray", "grey"]} pattern={""}/>
<RegexCompare texts={["0x01f", "0x12a", "0xAef"]} pattern={"[0-9a-fA-F]+"}/>
</Wrapper>
...
<RegexCompare texts={["acdefg"]} pattern={""}/>
...
<RegexCompare texts={["these", "are", "some", "words", "snake_case_variable1", "camelCaseVariable1"]} pattern={""}/>
<RegexCompare texts={["some    spaced       words"]} pattern={""}/>
...
<RegexCompare texts={["abcd0*     -x="]} pattern={""}/>
...
<RegexCompare texts={["color", "colour"]} pattern={"colo"}/>
<RegexCompare texts={["aaa", "bbb", "ccc"]}/>
